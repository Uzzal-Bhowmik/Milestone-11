...
const Register = () => {
  const { signUp, isLoading, googleSignIn } = useContext(AuthContext);
    ...
    <div className="flex justify-center items-center my-10">
      ...
      >
        <h4 className="text-2xl font-extrabold mb-8">
          Welcome, <span className="text-primary font-bold">Volunteer!</span>
        </h4>
        ...
        <p className="text-center mt-2">
          ...
          <Link to="/login" className="text-info underline font-bold">
            Login
          </Link>
        </p>
